...
> and product specifications. [What exists today](#what-exists-today) distinguishes
...
An edge such as “supports,” “contradicts” or “contributes to” carries scientific
...
- Published specifications, [architecture decisions](docs/DECISION_REGISTER.md)
  and an [open-questions register](docs/OPEN_QUESTIONS.md).

Humans and appropriately authorised agentic systems can contribute to the repository
through GitHub now. That contribution route is distinct from the **planned CRIC
agent runtime, knowledge-mutation pipeline and connected observability infrastructure**.

The complete evidence-to-analysis workflow, reference Event Cubes, model pipelines
and public research interfaces remain planned work. Installing cric-core provides
...
Help build climate-risk intelligence whose evidence and history remain open to inspection.**# Climate Risk Intelligence Commons
